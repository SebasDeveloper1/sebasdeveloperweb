  ...
  return (
    <section className="w-full bg-white dark:bg-dark-950">
      <div className="overflow-hidden flex flex-col justify-center items-center w-full">
        <section className="flex flex-col justify-center items-center gap-16 w-11/12 lg:w-10/12 py-16 md:py-32 border-t border-secondary-200 dark:border-secondary-800">
